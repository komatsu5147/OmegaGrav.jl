...
[examples/PlotFigure3.jl](https://github.com/komatsu5147/OmegaGrav.jl/tree/master/examples/PlotFigure3.jl), [examples/PlotFigure4a.jl](https://github.com/komatsu5147/OmegaGrav.jl/tree/master/examples/PlotFigure4a.jl), [examples/PlotFigure4b.jl](https://github.com/komatsu5147/OmegaGrav.jl/tree/master/examples/PlotFigure4b.jl), [examples/GenerateTable1.jl](https://github.com/komatsu5147/OmegaGrav.jl/tree/master/examples/GenerateTable1.jl), and [examples/GenerateTable2.jl](https://github.com/komatsu5147/OmegaGrav.jl/tree/master/examples/GenerateTable2.jl) to reproduce Figure 1-4b and Table 1,2 of the paper, respectively. Running these codes requires the python wrapper for CLASS [classy](https://github.com/lesgourg/class_public/wiki/Python-wrapper). The codes call `classy` via `PyCall`.
